...
class Gamepad:
    ...
    The joystick values are in the range -32768 to 32767."""
    ...
    def __init__(self, devices):
        ...
        # report[2,3] joystick 0 x: -32768 to 32767
        # report[4,5] joystick 0 y: -32768 to 32767
        # report[6,7] joystick 1 x: -32768 to 32767
        # report[8,9] joystick 1 y: -32768 to 32767
    ...
    def move_joysticks(self, x=None, y=None, z=None, r_z=None):
        ...
        All values must be in the range -32768 to 32767 inclusive.
    ...
    def _validate_joystick_value(value):
        if not -32768 <= value <= 32767:
            raise ValueError("Joystick value must be in range -32768 to 32767")
        return value